    ...
    return (
        ...
        <Table>
            ...
            <Scrollspy items={ ['dev-workshops', 'career-seminars', 'action-potential-initative'] } currentClassName="is-current">
                ...
                <tr>
                <td><strong><a href="/programs#dev-workshops">Development Workshops</a></strong></td>
                <td>
                    Helps students develop the skills required to succeed in college and in academic/professional environments
                </td>
                </tr>
                <tr>
                <td ><strong><a href="/programs#action-potential-initiative">Action Potential Initiative</a></strong></td>
                <td>
                ...
                <tr>
                <td ><strong><a href="/programs#career-seminars">Career Seminars</a></strong></td>
                <td>
